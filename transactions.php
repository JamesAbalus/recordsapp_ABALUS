...
$results_transactions = mysqli_fetch_all(mysqli_query($conn, $mysql), MYSQLI_ASSOC);
                ...
                <div class="container-fluid">
                    <div class="section">
                        ...
                        <table style="width: 100%; height: 100%;">
                            ...
                            <tbody>
                                <?php foreach ($results_transactions as $row1) : ?>
                                    <tr>

                                        <td><?php echo $row1['datelog']; ?></td>
                                        <td><?php echo $row1['document_code']; ?></td>
